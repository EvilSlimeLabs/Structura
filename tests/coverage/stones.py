...
structure = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, "test_structures", "All Blocks World", "Stones.mcstructure"))
pack_name = "Test Stone"
