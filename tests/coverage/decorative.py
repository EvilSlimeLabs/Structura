...
structure = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, "test_structures", "All Blocks World", "decorative.mcstructure"))
pack_name = "Test Decorative"
