...
structure = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, "test_structures", "All Blocks World", "gems and redstone.mcstructure"))
pack_name = "Test Gems and Redstone"
